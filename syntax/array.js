 ...
 */
export function bubbleSort(array, order = Sort.ASC){ return new Sort(array, order).bubbleSort() }
 ...
 */
export function selectionSort(array, order = Sort.ASC) { return new Sort(array, order).selectionSort() }
 ...
 */
export function insertionSort(array, order = Sort.ASC) { return new Sort(array, order).insertionSort() }
 ...
 */
export function mergeSort(array, order = Sort.ASC) { return new Sort(array, order).mergeSort() }
 ...
 */
export function quickSort(array, order = Sort.ASC) { return new Sort(array, order).quickSort() }
 ...
 */
export function heapSort(array, order = Sort.ASC) { return new Sort(array, order).heapSort() }
 ...
 */
export function countingSort(array, order = Sort.ASC) { return new Sort(array, order).countingSort() }
 ...
 */
export function bucketSort(array, bucketSize = 5, order = Sort.ASC) { return new Sort(array, order).bucketSort(bucketSize) }
 ...
 */
export function radixSort(array, radix = 10, order = Sort.ASC) { return new Sort(array, order).radixSort(radix) }
 ...
 */
export function shellSort(array, order = Sort.ASC) { return new Sort(array, order).shellSort() }
 ...
 * compact([]) // []
 */
export function compact(array){ return array.filter(item => item) }
 ...
 * filterNullish([]) // []
 */
export function filterNullish(array){ return array.filter(item => item != null) }
 ...
 */ 
export function countBy(array, fn){
    const counts = {};
    array.forEach(item => {
        const key = fn(item);
